...
- [x] 3. Implement core utilities and helpers
...
- [x] 3.2 Create password utility functions
...
- [x] 3.3 Create pagination utility
...
- [x] 3.4 Create response utility functions
...
- [x] 4. Implement validation schemas with Zod
- [x] 4.1 Create auth validation schemas
...
- [x] 4.2 Create user validation schemas
...
- [x] 4.6 Create group validation schemas
...
- [x] 5.2 Create role-based authorization middleware
...
- [x] 5.3 Create validation middleware
...
- [x] 5.4 Create error handling middleware
...
- [x] 6. Implement repository layer for data access
- [x] 6.1 Create user repository
...
- [x] 6.3 Create notice repository
...
- [x] 6.4 Create calendar repository
...
- [x] 6.6 Create password reset repository
...
- [x] 7. Implement service layer with business logic
- [x] 7.1 Create auth service
...
- [x] 8. Implement controller layer for request handling
...
- [x] 8.4 Create notice controller
...
- [x] 8.5 Create calendar controller
...
- [x] 9. Set up routing and API structure
...
- [x] 11. Implement Swagger/OpenAPI documentation
...
- [x] 12. Create database seeding script
...
- [x] 13. Set up development and production configurations
...
- [x] 14. Create server entry point
...
- [x] 16. Write comprehensive README
...
- [x] 17.1 Write auth integration tests
...
- [x] 17.2 Write user management integration tests
...
- [x] 17.5 Write calendar integration tests
...
- [x] 17.6 Write group integration tests
